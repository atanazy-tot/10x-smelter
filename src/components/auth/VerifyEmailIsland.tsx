...
export function VerifyEmailIsland() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        setSuccess("IF EMAIL EXISTS, VERIFICATION LINK SENT. CHECK YOUR INBOX");
      }
    } catch {
        ...
        <div className="w-full max-w-md bg-background border-2 border-border shadow-shadow p-6">
          <div className="flex flex-col gap-6">
            <div className="text-center">
              <h1 className="font-mono text-xl font-bold uppercase tracking-wider mb-2">VERIFY YOUR EMAIL</h1>
              <p className="font-mono text-sm text-foreground/60 uppercase">
